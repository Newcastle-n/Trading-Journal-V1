...
def main():
    ...
    # Chapters 9-13: personal / live-linked sections
    ch9 = chapter(
        "strategies",
        9,
        "استراتژی‌های فعال",
        "ستاپ‌های Primary و Secondary از مدیر استراتژی — همیشه با strategies.json همگام است.",
        [
            h2("نمای زنده", "space"),
            p("این فصل مستقیم از استراتژی‌های ثبت‌شده در اپ خوانده می‌شود. برای ویرایش از مدیر استراتژی استفاده کن."),
        ],
        mode="journal",
    )
    ...
    ch10 = chapter(
        ...
        10,
        "اشتباهات",
        "اشتباهات تکراری خودت را کوتاه و مشخص ثبت کن تا دوباره تکرار نشوند.",
        [
            h2("لیست اشتباهات", "space"),
            p("هر مورد یک الگوی اشتباه رفتاری یا اجرایی است."),
        ],
        mode="journal",
    )
    ch10["addLabel"] = "افزودن اشتباه"
    ch10["live"] = "mistakes"
    ch10["items"] = [
        {"id": "bk-m1", "text": "تغییر مکرر حدسود و حدضرر هنگام پوزیشن باز.", "createdAt": "2026-01-01T00:00:00.000Z"},
        {"id": "bk-m2", "text": "پس از دوره سوددهی، رعایت نکردن قوانینی که موجب سود می‌شد.", "createdAt": "2026-01-01T00:00:00.000Z"},
        {"id": "bk-m3", "text": "طمع پس از سود؛ خارج نشدن در TP2.", "createdAt": "2026-01-01T00:00:00.000Z"},
    ]
    ...
    ch11 = chapter(
        ...
        11,
        "درس‌ها",
        "درس‌های شخصی به‌علاوه درس‌های ثبت‌شده در ژورنال روزانه.",
        [
            h2("مرور درس‌ها", "space"),
            p("درس‌های دستی اینجا، و درس‌های فیلد ژورنال در بخش پایین صفحه دیده می‌شوند."),
        ],
        mode="journal",
    )
    ch11["addLabel"] = "افزودن درس"
    ch11["live"] = "lessons"
    ...
    ch12 = chapter(
        ...
        12,
        "چک‌لیست",
        "چک‌لیست‌های پیش‌سشن، حین معامله و پایان روز از پایگاه دانش — به‌همراه آیتم‌های شخصی.",
        [
            h2("چک‌لیست‌های عملیاتی", "space"),
            p("سه چک‌لیست اصلی از دانش ۱ اینجا هم نمایش داده می‌شوند. آیتم شخصی را پایین صفحه اضافه کن."),
        ],
        mode="journal",
    )
    ch12["addLabel"] = "افزودن آیتم چک‌لیست"
    ch12["live"] = "checklist"
    ...
    ch13 = chapter(
        ...
        13,
        "یادداشت‌های سریع",
        "اینباکس نکات کوتاه — همگام با دانش ۱ و دکمه ثبت نکته.",
        [
            h2("Inbox", "inbox"),
            p("نکات سریع اینجا و در دانش ۱ یکی هستند؛ ویرایش در هر کدام هر دو را به‌روز می‌کند."),
        ],
        mode="journal",
    )
    ch13["addLabel"] = "افزودن یادداشت سریع"
    ch13["live"] = "quick"
